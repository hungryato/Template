ers/template/vue-template/src/components/SideMenu.vue
<template>
  <!-- side navigation -->
  <nav class="krds-side-navigation">
    ...
    <ul class="lnb-list" role="menubar">
      <li class="lnb-item active" role="none">
        <button
          type="button"
          class="lnb-btn lnb-toggle active"
          role="menuitem"
          aria-controls="lnbmenu-1"
          aria-expanded="true"
        >
          2Depth-menu
        </button>
          ...
          <ul id="lnbmenu-1" role="menu">
            <li class="lnb-subitem" role="none">
              ...
              <div class="lnb-submenu-lv2" id="lnbmenu-2" role="menu">
                ...
                <ul>
                  <li role="none">
                    <a href="#" class="lnb-btn" role="menuitem">4Depth</a>
                  </li>
                  <li role="none">
                    <a href="#" class="lnb-btn" role="menuitem">4Depth</a>
                  </li>
            ...
            <li class="lnb-subitem" role="none">
              <a href="#" class="lnb-btn lnb-link" role="menuitem"
                >3Depth-link</a
              >
            </li>
            <li class="lnb-subitem active" role="none">
              <a
                href="#"
